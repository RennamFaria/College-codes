public class Triangulo implements Cloneable{
  ...
  public Triangulo clone() {
    try {
      Triangulo trianguloClone = (Triangulo) super.clone();
      trianguloClone.setPonto1(ponto1.clone());
      trianguloClone.setPonto2(ponto2.clone());
      trianguloClone.setPonto3(ponto3.clone());
      
      return trianguloClone;
