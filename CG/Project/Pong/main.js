...
function main(){
	...
	function presetBall (){
		ball_pos = [250, 250];
		ball_speed_start[0] = Math.random()/3;
		ball_speed_start[1] = Math.random()/3;
		// console.log(ball_speed_start)

		negative = Math.random();
		if (negative > 0.5) {
			ball_speed_start[0] = -ball_speed_start[0]
		}
		negative = Math.random();
		if (negative > 0.5) {
			ball_speed_start[1] = -ball_speed_start[1]
		}
		ball_speed = [ball_speed_start[0], ball_speed_start[1]];
	}
	...
	function drawFrame()
	{
		...
		// score tracking
		if (ball_pos[0] >= 500 || ball_pos[0] <= 0) {
			if(ball_pos[0] >= 500)
	...
	function updatePlayer2Score(points) {
		score2 += points;
